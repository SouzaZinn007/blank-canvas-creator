...
const roles: RoleCard[] = [
  {
    role: "ADMIN",
    title: "Admin",
    subtitle: "People • Content • Commercial • Reports • System",
  ...
  },
  {
    ...
    subtitle: "Audios • E-books • Trainings • Placement Tests",
  ...
  },
  {
    role: "ALUNO",
    title: "Aluno",
    subtitle: "Audios • Shop (if enabled) • Extras",
    ...
    <div className="min-h-screen w-full bg-[#F7FAFC] flex items-center justify-center p-6">
      <div className="w-full max-w-5xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900">
                Smart Idiomas — Login (Dev)
              </h1>
              <p className="text-slate-600">
                Choose a profile to simulate authentication.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 text-sm text-slate-500">
          Writes <code>smart_auth</code> to localStorage. Temporary dev login.
        </div>
      </div>
    </div>
  );
